...
var projectDesc = [
    ...
    { id:2,  url:'https://goo.gl/3EDo1c', title: 'DEVOPS TALKS CONFERENCE', skills: 'PSD to HTML, CSS3, JS, JQUERY, PHOTOSHOP, RESPONSIVE, BOOTSTRAP, GULP, NPM, GIT'},
    { id:3,  url:'https://goo.gl/G1Od8d', title: 'Akreev designer portfolio', skills: 'PSD to HTML, CSS3, JS, JQUERY, PHOTOSHOP, RESPONSIVE, BOOTSTRAP, GULP, NPM, GIT'},
    { id:4,  url:'https://goo.gl/BeYqy8', title: 'Glenerin Inn & Spa', skills: 'FIXING, new layouts, slider, HTML, CSS3, JS, JQUERY, WORDPRESS'},
    { id:5,  url:'https://goo.gl/Xg29Kr', title: 'GLOBAL MANUFACTURER OF STRETCH CEILING', skills: 'Fixing errors, MODX, psd to HTML, CSS3'},
    { id:6,  url:'https://goo.gl/dPHJJz', title: 'Real Estate Agent', skills: 'Wordpress, add news, some fixing, HTML, CSS, JQUERY, slider, video, PHOTOSHOP'},
    { id:7,  url:'https://goo.gl/jN2mEz', title: 'National ATM Wholesale', skills: 'OpenCart, customized layouts theme,psd to HTML, BOOTSTRAP, CSS, SCSS, JS, JQUERY, PHOTOSHOP, RESPONSIVE, GIT'},
    { id:8,  url:'https://goo.gl/sZTPY8', title: 'QUALITY REPLACEMENT WINDOWS', skills: 'Wordpress, new layouts, some fixing,psd to HTML, CSS, JQUERY, slider, PHOTOSHOP, GIT'},
    { id:9,  url:'https://goo.gl/1enMTJ', title: 'Personal Injury Lawyers', skills: 'Wordpress, new layouts, plugins, some fixing, HTML, CSS, JQUERY, PHOTOSHOP, GIT'},
    { id:10, url:'https://goo.gl/cxcyHo', title: 'Custom Home Builders Hamilton', skills: 'Wordpress, new layouts, plugins, some fixing, HTML, CSS, JQUERY, PHOTOSHOP, GIT'},
    { id:11, url:'https://goo.gl/uJfKp4', title: 'Business Analytics & Digital Marketing', skills: 'Webpack, Gulp, NPM, SCSS, PUG, FLEXBOX, BOOTSTRAP, JS, PSD to PUG, video, sliders'},
