...
const divSelector = '.water-bg';
const canvasSelector = '.water-bg-canvas';
const filePath = ('../../../images/backgrounds/water.jpg');
const fileMapsPath = ('../../../images/backgrounds/water-maps.jpg');
